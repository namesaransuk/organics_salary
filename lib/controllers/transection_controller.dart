...
class TransectionController extends GetxController {
  ...
  var transectionProcessList = RxList([]);
  var transectionSuccessList = RxList([]);

  void loadDataProcess() async {
    ...
    try {
      ...
      if (responseBody['statusCode'] == '200') {
        transectionProcessList.assignAll(responseBody['data'] as List<dynamic>);
      } else {
        transectionProcessList.clear();
  ...
  void loadDataSuccess() async {
    ...
    try {
      ...
      if (responseBody['statusCode'] == '200') {
        transectionSuccessList.assignAll(responseBody['data'] as List<dynamic>);
      } else {
