...
class CoinQuantityScreen extends StatefulWidget {
  const CoinQuantityScreen({super.key});

  @override
  State<CoinQuantityScreen> createState() => _CoinQuantityScreenState();
}

class _CoinQuantityScreenState extends State<CoinQuantityScreen> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Obx(
          () => walletController.historyCoinExchange.isNotEmpty
              ? Expanded(
                  child: Column(
                    children: [
                      Container(
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: walletController.historyCoinExchange
                                .map((item) {
                              DateTime parsedDate =
