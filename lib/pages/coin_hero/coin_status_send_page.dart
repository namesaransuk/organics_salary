...
class CoinStatusSendPage extends StatefulWidget {
  const CoinStatusSendPage({super.key});

  @override
  State<CoinStatusSendPage> createState() => _CoinStatusSendPageState();
}

class _CoinStatusSendPageState extends State<CoinStatusSendPage> {
  @override
  void dispose() {
    super.dispose();
  }
