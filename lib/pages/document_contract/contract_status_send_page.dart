...
class ContractStatusSendPage extends StatefulWidget {
  const ContractStatusSendPage({super.key});

  @override
  State<ContractStatusSendPage> createState() => _ContractStatusSendPageState();
}

class _ContractStatusSendPageState extends State<ContractStatusSendPage> {
  @override
  void dispose() {
    super.dispose();
  }
