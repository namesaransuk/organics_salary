...
class ProvidentFundStatusSendPage extends StatefulWidget {
  const ProvidentFundStatusSendPage({super.key});

  @override
  State<ProvidentFundStatusSendPage> createState() =>
      _ProvidentFundStatusSendPageState();
}

class _ProvidentFundStatusSendPageState
    extends State<ProvidentFundStatusSendPage> {
  @override
  void dispose() {
    super.dispose();
  }
