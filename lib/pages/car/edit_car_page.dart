...
class _EditCarPageState extends State<EditCarPage> {
  ...
  Widget build(BuildContext context) {
    TextEditingController registrationInput = TextEditingController(
        text: carController.carList.first.carRegistration);
    TextEditingController brandInput =
        TextEditingController(text: carController.carList.first.carBrand);
    TextEditingController colorInput =
        TextEditingController(text: carController.carList.first.carColor);

    carController.selectedCarText.value = carController.carList.isNotEmpty
        ? carController.carList.first.carCategoryId.toString()
        : 'เลือกประเภทรถ';
    return Scaffold(
      appBar: AppBar(
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    Obx(
                                      () => DropdownButtonFormField(
                                        ...
                                        value:
                                            carController.selectedCarText.value,
                          ...
                          Column(
                            children: [
                              ...
                              Center(
                                // child: Image.network('$baseUrl/${carController.carList.first.carImage!.filePath}'),
                                child: carController.selectedImages.isEmpty
                                    ? Image.network(
