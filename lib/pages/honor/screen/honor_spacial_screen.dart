...
class HonorSpacialScreen extends StatefulWidget {
  const HonorSpacialScreen({super.key});

  @override
  State<HonorSpacialScreen> createState() => _HonorSpacialScreenState();
}

class _HonorSpacialScreenState extends State<HonorSpacialScreen> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return honorController.honorSpecialList.isNotEmpty
          ? ListView(
              children: [
                const Align(
                ...
                Padding(
                  ...
                  child: Column(
                    children: honorController.honorSpecialList
                        .map(
                          (item) => Column(
                            children: [
                              Row(
