...
class SavingsStatusSendPage extends StatefulWidget {
  const SavingsStatusSendPage({
    super.key,
  });

  @override
  State<SavingsStatusSendPage> createState() => _SavingsStatusSendPageState();
}

class _SavingsStatusSendPageState extends State<SavingsStatusSendPage> {
  @override
  void dispose() {
    super.dispose();
  }
