...
class SocialSecurityStatusSendPage extends StatefulWidget {
  const SocialSecurityStatusSendPage({super.key});

  @override
  State<SocialSecurityStatusSendPage> createState() =>
      _SocialSecurityStatusSendPageState();
}

class _SocialSecurityStatusSendPageState
    extends State<SocialSecurityStatusSendPage> {
  @override
  void dispose() {
    super.dispose();
  }
